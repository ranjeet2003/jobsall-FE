    ...
    return ( 
      <div className="footer-container pa">
          <ul>
            ...
            <li>
                <b><Link href="">Follow Us</Link></b>
                <span className="df">
                    <Image src="/images/Facebook.png" alt="me" width="20" height="20"/>
                    <Link href="">Facebook</Link>
                </span>
                <span className="df">
                    <Image src="/images/Telegram App.png" alt="me" width="20" height="20"/>
            ...
            <li>
                <b><Link href="">Today's Top Clicked</Link></b>
